...
public class PathValue implements Writable, WritableComparable<PathValue>{
    ...
    public PathValue(IntWritable count, IntWritable totalCount, IntWritable totalPathSlotXCount, IntWritable totalPathSlotYCount, IntWritable wordSlotXCount, IntWritable wordSlotYcount, BooleanWritable isFirst) {
        this.count = count;
    ...
    public PathValue(int count, int totalCount, int totalPathSlotXCount, int totalPathSlotYCount, int wordSlotXCount, int wordSlotYCount, boolean isFirst) {
        this(new IntWritable(count), new IntWritable(totalCount), new IntWritable(totalPathSlotXCount), new IntWritable(totalPathSlotYCount), new IntWritable(wordSlotXCount), new IntWritable(wordSlotYCount), new BooleanWritable(isFirst));
    }

    public PathValue(int count, boolean isFirst) {
        this(count, 0, 0, 0, 0, 0, isFirst);
    ...
    public PathValue(PathValue other){
        this(other.getCount(), other.getTotalCount(), other.getTotalPathSlotXCount(), other.getTotalPathSlotYCount(), other.getWordSlotXCount(), other.getWordSlotYcount(), other.getIsFirst());
    }
